...
```{r}
par(mfrow= c(1,2))
recaudo_hist <- hist(project_data$Attendance,main="Histograma de ",xlab="label",ylab="label",ylim = c(0,10),breaks=6)
recaudo_bp <- boxplot(project_data$Attendance,main="Diagrama de caja de ",ylab="label")
```
...
```{r}
par(mfrow= c(1,2))
recaudo_hist <- hist(project_data$Playing.weeks,main="Histograma de ",xlab="label",ylab="label",ylim = c(0,10),breaks=6)
recaudo_bp <- boxplot(project_data$Playing.weeks,main="Diagrama de caja de ",ylab="label")
```
...
```{r}
par(mfrow= c(1,2))
recaudo_hist <- hist(project_data$New.Productions,main="Histograma de ",xlab="label",ylab="label",ylim = c(0,10),breaks=6)
recaudo_bp <- boxplot(project_data$New.Productions,main="Diagrama de caja de ",ylab="label")
```
...
```{r}
par(mfrow= c(1,2))
recaudo_hist <- hist(project_data$Mean.ticket,main="Histograma de ",xlab="label",ylab="label",ylim = c(0,10),breaks=6)
recaudo_bp <- boxplot(project_data$Mean.ticket,main="Diagrama de caja de ",ylab="label")
```
...
```{r}
par(mfrow= c(1,2))
recaudo_hist <- hist(project_data$Pct.sold,main="Histograma de ",xlab="label",ylab="label",ylim = c(0,10),breaks=6)
recaudo_bp <- boxplot(project_data$Pct.sold,main="Diagrama de caja de ",ylab="label")
```
...
```{r}
par(mfrow= c(1,2))
recaudo_hist <- hist(project_data$LogGross,main="Histograma de ",xlab="label",ylab="label",ylim = c(0,10),breaks=6)
recaudo_bp <- boxplot(project_data$LogGross,main="Diagrama de caja de ",ylab="label")
```
