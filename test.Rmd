...
+ QQplot: La mayoria de los datos se ajustan a la recta salvo 3 excepciones.
...
```{r}
mod_lgross_3 <- lm(train_df$LogGross ~ train_df$Attendance + train_df$Playing.weeks 
             + train_df$Mean.ticket + train_df$Pct.sold - 1)
...
```{r}
predict(mod_lgross_3, validate_df, interval="prediction")
```
